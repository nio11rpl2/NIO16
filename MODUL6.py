...
outline="#dbf", fill="#dbf"\
    ...
    def create(self, event):
        ...
        if self.game_over == False:
            if event.keycode == 111: #untuk linux nilai nya adalah 111
                self.direction = "up"
            elif event.keycode == 114: #untuk linux nilai nya adalah 114
                self.direction = "right"
            elif event.keycode == 116: #untuk linux nilai nya adalah 116
                self.direction = "down"
            elif event.keycode == 113: #untuk linux nilai nya adalah 113
                self.direction = "left"
...
int(frontCoords[0]-endCoords[0]),\
    ...
    def make_new_dot(self):
        ...
        self.dot
        self.canvas.create_rectangle(dotX,dotY,dotX+self.rectWidth,dotY+self.rectWidth\
